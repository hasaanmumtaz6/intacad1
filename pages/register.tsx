...
//     if (res?.error) {
//       setError("Invalid Username orr password");
//       setTimeout(() => {
//         setError("");
//       }, 10000);
...
//   // Ui converter states
//   const [signupCick, setSignupClick] = useState(false);
...
//       <Head>
//         <title>
//           {signupCick ? "Register - StartupMAXIM" : "Login - StartupMAXIM"}
//         </title>
//       </Head>
//       <div className={`container-box ${signupCick ? "sign-up-mode" : ""}`}>
...
//               <p className="social-text">Or SignIn with Social Plateform</p>
//               <div className="social-media">
//                 <Link href="/register/#" className="socail-icons">
//                   <FaGoogle />
//                 </Link>
//                 <Link href="/register/#" className="socail-icons">
//                   <FaGithub />
...
//                 Sign up
//               </button>
//               <p className="social-text">Or Signup with Social Plateform</p>
//               <div className="social-media">
//                 <Link href="/register/#" className="socail-icons">
//                   <FaGoogle />
//                 </Link>
...
//                 Mollitia suscipit delectus minima.
//               </p>
//               <button
...
const RegisterPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{signupClick ? "Register - StartupMAXIM" : "Login - StartupMAXIM"}</title>
      </Head>
        ...
        <div className="forms-container">
          <div className="signin-signup">
            ...
            <form className="sign-up-form" onSubmit={registeruser}>
              ...
              {registerError && <p className="text-[#ff00009d] pb-2 pt-3">{registerError}, Please <b onClick={handleSignIn} className="cursor-pointer">Login</b></p>}
        ...
        <div className="panels-container">
          <div className="panel left-panel">
            <div className="content">
              <h3>New Here?</h3>
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Mollitia suscipit delectus minima.
              </p>
